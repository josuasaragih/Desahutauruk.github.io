...
<head>
	...
	<title>Data Penduduk Apps</title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> Desa Hutauruk</span>
			</a>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              ...
              //default
              default:
                  echo "<center><h1> Search Di Menu Data Penduduk & Sirkulasi Penduduk !</h1></center>";
                  break;    
          }
      }else{
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/josua.ac/">
					<strong> Josua Saragih</strong>
				</a>
				All rights reserved.
			</div>
			<b>Horas..Horas..Horas..!!</b>
		</footer>
